    ...
    <footer className="bg-[#0D0D0D] border-t border-white/[0.06]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1.2fr_1.2fr] gap-12 lg:gap-8">
          ...
          <div>
            ...
            <p className="text-white/30 text-[13px] leading-relaxed max-w-[260px] mb-8">
            ...
            <div className="space-y-2">
              <a href="tel:+911244277219" className="flex items-center gap-3 text-white/28 hover:text-white text-[12px] transition-colors duration-200 group">
              ...
              <a href="mailto:info@orangesourcing.com" className="flex items-center gap-3 text-white/28 hover:text-white text-[12px] transition-colors duration-200 group">
                <div className="w-7 h-7 border border-white/[0.07] flex items-center justify-center flex-shrink-0 group-hover:border-[#F97316]/40 transition-colors duration-200">
              ...
              <div className="flex items-start gap-3 text-white/28 text-[12px] leading-relaxed">
          ...
          {/* Navigate column */}
          <div>
            <div className="text-white/20 text-[10px] font-bold tracking-[0.22em] uppercase mb-5">Navigate</div>
            ...
            <nav className="flex flex-col gap-3">
              {[
                ...
                <Link key={l.label} to={l.to}
                  className="text-white/38 hover:text-white text-[13px] font-medium transition-colors duration-200 hover:translate-x-1 inline-block" style={{ transition: 'color 0.2s, transform 0.2s' }}>
                  {l.label}
                </Link>
              ))}
            </nav>
          ...
          {/* Services column */}
          <div>
            <div className="text-white/20 text-[10px] font-bold tracking-[0.22em] uppercase mb-5">Services</div>
            <div className="w-6 h-[1px] bg-[#F97316] mb-6" />
            <div className="flex flex-col gap-3">
              {SERVICES.map(s => (
                <Link key={s.id} to="/services"
                  className="text-white/28 hover:text-white/60 text-[12px] leading-snug transition-colors duration-200">
                  {s.title}
                </Link>
              ))}
            </div>
          ...
          {/* Countries column */}
          <div>
            <div className="text-white/20 text-[10px] font-bold tracking-[0.22em] uppercase mb-5">Manufacturing</div>
            <div className="w-6 h-[1px] bg-[#F97316] mb-6" />
            <div className="flex flex-col gap-3 mb-8">
              {['India', 'Sri Lanka', 'Bangladesh', 'China', 'Mauritius', 'Madagascar'].map(c => (
                <div key={c} className="flex items-center gap-2.5 text-white/28 text-[12px]">
      ...
      <div className="border-t border-white/[0.05] px-6 py-5">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div className="text-white/15 text-[11px] font-medium">
          ...
          >
            <span className="text-white/18 text-[11px]">Powered by</span>
